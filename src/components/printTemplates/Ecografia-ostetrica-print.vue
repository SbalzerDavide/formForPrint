<script>
  ...
  export default {
    ...
    computed: {
      ...
      // Ecografia Ostetrica Print Data getters
      pregnancy: {
        get() {
          return this.$store.state.ecografiaOstetricaPrintData.pregnancy
        }
      },
      ecoType: {
        get() {
          return this.$store.state.ecografiaOstetricaPrintData.ecoType
        }
      },
      ecoMethod: {
        get() {
          return this.$store.state.ecografiaOstetricaPrintData.ecoMethod
        }
      },
      fetusNumber: {
        get() {
          return this.$store.state.ecografiaOstetricaPrintData.fetusNumber
        }
      },
      decimalWeeks: {
        get() {
          return this.$store.state.ecografiaOstetricaPrintData.decimalWeeks
        }
      },
      enableCRLReDate: {
        get() {
          return this.$store.state.ecografiaOstetricaPrintData.enableCRLReDate
        }
      },
      externalCRLReDate: {
        get() {
          return this.$store.state.ecografiaOstetricaPrintData.externalCRLReDate
        }
      },
      decimalWeeksFromCRL: {
        get() {
          return this.$store.state.ecografiaOstetricaPrintData.decimalWeeksFromCRL
        }
      },
      biometriaFetale: {
        get() {
      ...
      doppler: {
        get() {
          return this.$store.state.ecografiaOstetricaPrintData.doppler
        }
      },
      heart: {
        get() {
          return this.$store.state.ecografiaOstetricaPrintData.heart
        }
      },
      liquid: {
        get() {
          return this.$store.state.ecografiaOstetricaPrintData.liquid
        }
      },
      direction: {
        get() {
          return this.$store.state.ecografiaOstetricaPrintData.direction
        }
      },
      placenta: {
        get() {
          return this.$store.state.ecografiaOstetricaPrintData.placenta
        }
      },
      patientMore: {
        get() {
          return this.$store.state.ecografiaOstetricaPrintData.patientMore
        }
      },
      pregnancyMore: {
        get() {
          return this.$store.state.ecografiaOstetricaPrintData.pregnancyMore
        }
      },
      ecoMore: {
        get() {
          return this.$store.state.ecografiaOstetricaPrintData.ecoMore
        }
      },
      biometriaMore: {
        get() {
          return this.$store.state.ecografiaOstetricaPrintData.biometriaMore
        }
      },
      lastMore: {
        get() {
          return this.$store.state.ecografiaOstetricaPrintData.lastMore
        }
      },
      conclusion: {
        get() {
          return this.$store.state.ecografiaOstetricaPrintData.conclusion
        }
      },
      policyType: {
        get() {
          return this.$store.state.ecografiaOstetricaPrintData.policyType
        }
      }
    },
